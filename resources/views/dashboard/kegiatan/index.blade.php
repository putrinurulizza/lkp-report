...
@section('content')
    ...
    {{-- Modal Management Kegiatan --}}
    <div class="modal fade " id="management" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered">
          <div class="modal-content ">
            <div class="modal-header">
              <h1 class="modal-title fs-5 text-dark" id="exampleModalLabel">Management Kegiatan</h1>
            ...
            <div class="modal-body text-dark">
                 ...
                 <tbody>
                     @foreach ($details as $detail)
                         @if ($detail->kegiatans->id_user == auth()->user()->id)
                             <tr>
                                 <td>{{ $loop->iteration }}</td>
                                 <td>{{ $kegiatan->tanggal }}</td>
                                 ...
                                 <td>
                                     <button class="btn btn-sm btn-warning" data-bs-toggle="modal"
                                         data-bs-target="#modalEditDetail{{ $loop->iteration }}" aria-label="Close">
                                         <i class="fa-regular fa-pen-to-square fa-lg"></i>
                                     </button>
                                     <button class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                         data-bs-target="#modalHapusDetail{{ $loop->iteration }}" aria-label="Close">
                                         <i class="fa-regular fa-trash-can fa-lg"></i>
                                     </button>
                                 </td>
                             </tr>
                             ...
                             <!-- Edit Data Kegiatan -->
                             <x-form_modal>
                                 @slot('id', "modalEditDetail$loop->iteration")
                                 ...
                                 <div class="row">
                                     <div class="mb-3">
                                         {{-- <input type="hidden" value="{{ old('id', $kegiatan->kegiatans->id) }}"> --}}
                                         <label for="tanggal" class="form-label text-dark">Tanggal</label>
                                         <input type="date"
                                     ...
                                     <div class="mb-3">
                                         ...
                                         <input type="text"
                                             ...
                                             value="{{ old('kegiatan', $kegiatan->kegiatan) }}" autofocus
                                             required>
                                         @error('kegiatan')
                                             <div class="invalid-feedback">
                                                 {{ $message }}
                                     ...
                                     <div class="mb-3">
                                         ...
                                         <input type="text"
                                             ...
                                             name="hasil" id="hasil"
                                             value="{{ old('hasil', $kegiatan->hasil) }}" autofocus required>
                                         @error('hasil')
                                             <div class="invalid-feedback">
                                                 {{ $message }}
                                             </div>
                             ...
                             <!-- Hapus Data Kegiatan -->
                             <x-form_modal>
                                 @slot('id', "modalHapusDetail$loop->iteration")
                                 @slot('title', 'Hapus Data Kegiatan')
                                 @slot('route', route('kegiatan.destroy', $kegiatan->id))
                                 @slot('method') @method('delete') @endslot
                                 @slot('btnPrimaryClass', 'btn-outline-danger')
